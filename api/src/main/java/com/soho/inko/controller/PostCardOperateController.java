...
public class PostCardOperateController {
    ...
    @Autowired
    public PostCardOperateController(IPostCardService postCardService, EnvelopeRepository envelopeRepository, FormatTypeRepository formatTypeRepository, @SuppressWarnings("SpringJavaAutowiringInspection") JmsMessagingTemplate jmsMessagingTemplate) {
