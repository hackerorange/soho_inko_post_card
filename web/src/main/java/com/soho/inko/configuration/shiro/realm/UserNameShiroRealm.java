package com.soho.inko.configuration.shiro.realm;
 ...
 * MyShiroRealm
 */
public class UserNameShiroRealm extends AuthorizingRealm {

    private static final Logger logger = LoggerFactory.getLogger(UserNameShiroRealm.class);
    //
//    @Autowired
...
//        // 返回null的话，就会导致任何用户访问被拦截的请求时，都会自动跳转到unauthorizedUrl指定的地址
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(
        ...
        UserEntity userEntity = userRepository.findByUserName(token.getUsername());
        if (!TypeChecker.isNull(userEntity)) {
