...
import com.soho.framework.configuration.shiro.configuration.properties.ShiroFilterProperties;
import com.soho.framework.configuration.shiro.configuration.properties.ShiroPasswordProperties;
import com.soho.framework.configuration.shiro.realm.EmailShiroRealm;
import com.soho.framework.configuration.shiro.realm.UserNameShiroRealm;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shirFilter(
        ...
        shiroFilterProperties.getFilterChainDefinition().put("/**", "anon");
